...
|     10      | Написать программу, вычисляющую для заданного n значение функции $f(n) = \begin{cases} \frac{n}{2}, & \text{если } n \text{ четное} \\ 3n + 1, & \text{если } n \text{ нечетное} \end{cases}$ |
