...
![Python org](../misc/01/pythonorg.png)
...
![starting install](../misc/01/start_install.png)
...
![installing step 2](../misc/01/step_2_installing_python.png)
...
![end_installing_python](../misc/01/end_installing_python.png)
...
![starting install pycharm](../misc/01/start_install_pycharm.png)

Далее необходимо выбрать путь установки программы

![step 2 to install pycharm](../misc/01/step_2_install_pycharm.png)
...
![step 3 to install pycharm](../misc/01/step_3_install_pycharm.png)

Далее требуется выбрать имя для папки в меню Пуск

![step 4 to install pycharm](../misc/01/step_4_install_pycharm.png)

Далее PyCharm будет установлен на ваш компьютер.

![end to install pycharm](../misc/01/end_install_pycharm.png)
...
![create new project](../misc/01/create_project.png)

Укажите путь до проекта Python и интерпретатор, который будет использоваться
для запуска и отладки.

![chose type of project](../misc/01/chose_type_project.png)
